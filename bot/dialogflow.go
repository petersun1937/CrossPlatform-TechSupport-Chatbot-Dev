...
func (b *BaseBot) GetSessionID(platform Platform, identifier interface{}) (string, error) {
	switch platform {
	case LINE:
...
// 	conf := b.conf
// 	response, err := b.detectIntentText(conf.DialogflowProjectID, sessionID, text, "en")
// 	if err != nil {
...
// func (b *BaseBot) detectIntentText(projectID, sessionID, text, languageCode string) (*dialogflowpb.DetectIntentResponse, error) {
