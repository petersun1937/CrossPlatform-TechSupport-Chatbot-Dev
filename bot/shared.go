...
func (b *BaseBot) HandleCommand(command string) string {
	...
	case "/help":
		...
		message += "/disable_dialogflow - Disable Dialogflow intent matching.\n"
		message += "Only one AI model can be active at a time, while you can enable Dialogflow independently."
